// BACKEND API - Quản lý khuyến mãi HIỂN THỊ (Body)
import { NextRequest, NextResponse } from 'next/server';
import fs from 'fs';
import path from 'path';

const DATA_FILE = path.join(process.cwd(), 'data', 'display-promotions.json');
...
// GET - Lấy tất cả khuyến mãi display
export async function GET(request: NextRequest) {
  try {
    console.log('🔵 API Display Promotions được gọi');
